<%-- 
    ...
    Created on : 26/09/2016, 23:32:21
    Author     : Jeremías
--%>
...
<html lang="es">
    <head>
        <title>QuickList | Registrarse</title>
        <meta charset="UTF-8">
        ...
        <div class="contenedor">
            ...
            <div class="cuerpo">
                <div class="formulario">
                    <h2>Registrarse</h2><p class="msg_error">${param.message}</p><p class="msg_correcto">${param.message2}</p><br>
                    <form method="POST" action="RegistrarUsuario">
                        ...
                        <input class="entrada_form" type="password" placeholder="Repetir contraseña" name="password2">
                        <input class="input_left" type="password" placeholder="PIN" name="pin">
